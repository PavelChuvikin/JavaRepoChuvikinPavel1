...
//создаем коробки с нулем фруктов в каждой
        Box<Apple,Integer,Double, Integer> boxForApple = new Box<> (Apple, 0, Apple.weight, 1);
        Box<Orange,Integer,Double, Integer> boxForOrange1 = new Box<> (Orange, 0, Orange.weight, 2);
        Box<Orange,Integer,Double, Integer> boxForOrange2 = new Box<> (Orange, 0, Orange.weight, 3);
//добавляем фрукты
        addFruit(boxForApple, 3);
        addFruit(boxForOrange1,12);
...
//сравниваем вес коробок
        System.out.println("Разница в весе " + boxForApple.compare(boxForOrange1) + " кг");
